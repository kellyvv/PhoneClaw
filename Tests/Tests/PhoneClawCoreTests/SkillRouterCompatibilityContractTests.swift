...
final class SkillRouterCompatibilityContractTests: XCTestCase {
    ...
    func testLiveDynamicIslandSeparatesVoiceAndThinkingGlyphs() throws {
        ...
        XCTAssertTrue(widget.contains("private struct LiveSixDotVoiceWave: View"))
        XCTAssertTrue(widget.contains("private struct LiveRotatingSkillDotRing: View"))
        ...
        XCTAssertTrue(widget.contains("private let liveIslandFrameInterval: TimeInterval = 1.0 / 30.0"))
        ...
        XCTAssertTrue(widget.contains("TimelineView(.periodic(from: .now, by: liveIslandFrameInterval))"))
        ...
        XCTAssertTrue(widget.contains("sin(t * 7.0"))
        XCTAssertTrue(widget.contains("let envelope = 0.62 + 0.38"))
        XCTAssertTrue(widget.contains("let rotation = t * 1.45"))
        XCTAssertTrue(widget.contains("let phase = rotation + Double(index) * .pi * 2.0 / 6.0"))
        XCTAssertTrue(widget.contains("cos(phase)"))
        XCTAssertTrue(widget.contains("sin(phase)"))
        XCTAssertTrue(widget.contains(".rotationEffect(.degrees(t * 42.0))"))
