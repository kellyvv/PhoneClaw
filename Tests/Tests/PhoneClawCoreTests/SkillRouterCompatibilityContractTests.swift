...
final class SkillRouterCompatibilityContractTests: XCTestCase {
    ...
    func testLiveDynamicIslandSeparatesVoiceAndThinkingGlyphs() throws {
        ...
        XCTAssertTrue(widget.contains("private struct LiveCompactStatusPulse: View"))
        ...
        XCTAssertTrue(widget.contains("LiveCompactGlyph(presentation: presentation, size: 24)"))
        XCTAssertTrue(widget.contains("LiveProgressRing(presentation: presentation, size: 18)"))
        XCTAssertTrue(widget.contains(".frame(width: 34, height: 32)"))
        XCTAssertTrue(widget.contains(".frame(width: 42, height: 28)"))
