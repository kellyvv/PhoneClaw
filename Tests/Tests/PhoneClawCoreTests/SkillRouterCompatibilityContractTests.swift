...
final class SkillRouterCompatibilityContractTests: XCTestCase {
    ...
    func testLiveDynamicIslandSeparatesVoiceAndThinkingGlyphs() throws {
        ...
        XCTAssertTrue(widget.contains("LiveCompactLeadingSurface(presentation: presentation)"))
        XCTAssertTrue(widget.contains("LiveCompactTrailingSurface(presentation: presentation)"))
        XCTAssertTrue(widget.contains("LiveCompactGlyph(presentation: presentation, size: 22)"))
        XCTAssertTrue(widget.contains("private struct LiveCompactHalo: View"))
        ...
        XCTAssertTrue(widget.contains("private struct LiveSignalDot: View"))
        XCTAssertTrue(widget.contains("var primaryLine: String"))
        XCTAssertTrue(widget.contains("var moodText: String"))
        XCTAssertTrue(widget.contains("var compactTitle: String"))
        XCTAssertTrue(widget.contains("var compactStageText: String"))
        ...
        XCTAssertTrue(widget.contains("TimelineView(.animation(minimumInterval: 0.14"))
        XCTAssertTrue(widget.contains("TimelineView(.animation(minimumInterval: 0.10"))
        XCTAssertTrue(widget.contains("TimelineView(.animation(minimumInterval: 0.16"))
        XCTAssertTrue(widget.contains("ForEach(0..<5"))
        XCTAssertTrue(widget.contains("ForEach(0..<4"))
        XCTAssertTrue(widget.contains("sin(t * 6.8"))
        XCTAssertTrue(widget.contains("t * 3.2"))
        ...
        XCTAssertTrue(widget.contains("var usesVoiceWave: Bool { stage == .voice }"))
        XCTAssertTrue(widget.contains("var usesThinkingGlyph: Bool"))
        XCTAssertTrue(widget.contains("case \"listening\": return 0.18"))
        XCTAssertTrue(widget.contains("case \"starting\", \"listening\": return 0.3"))
        XCTAssertTrue(widget.contains("case \"listening\": return 30"))
        XCTAssertTrue(widget.contains("LiveCompactGlyph(presentation: presentation, size: 18)"))
        XCTAssertTrue(widget.contains("Text(presentation.compactTitle)"))
        XCTAssertTrue(widget.contains("Text(presentation.compactStageText)"))
        XCTAssertTrue(widget.contains(".font(.system(size: 11, weight: .heavy, design: .rounded))"))
        XCTAssertTrue(widget.contains(".font(.system(size: 13, weight: .heavy, design: .rounded))"))
        XCTAssertTrue(widget.contains(".frame(width: 72, height: 30)"))
        XCTAssertTrue(widget.contains(".frame(width: 50, height: 28)"))
    ...
    func testLiveDynamicIslandExpandedModeUsesLargeLivePanel() throws {
        ...
        XCTAssertTrue(widget.contains("DynamicIslandExpandedRegion(.center, priority: 1)"))
        XCTAssertTrue(widget.contains("DynamicIslandExpandedRegion(.trailing, priority: 2)"))
        XCTAssertTrue(widget.contains("DynamicIslandExpandedRegion(.bottom, priority: 3)"))
        XCTAssertTrue(widget.contains("LiveIslandLeadingRail(presentation: presentation)"))
        XCTAssertTrue(widget.contains("LiveIslandCenterLabel(presentation: presentation)"))
        XCTAssertTrue(widget.contains("LiveIslandTrailingRail(presentation: presentation)"))
        XCTAssertTrue(widget.contains("LiveIslandBottomPanel(presentation: presentation)"))
        XCTAssertTrue(widget.contains("private struct LiveIslandSurroundingVisual: View"))
        ...
        XCTAssertTrue(widget.contains("LiveSignalDot(presentation: presentation, size: 6)"))
        XCTAssertTrue(widget.contains(".frame(width: 68, height: 40"))
        XCTAssertTrue(widget.contains(".frame(width: 48, height: 32"))
        XCTAssertTrue(widget.contains(".frame(maxWidth: .infinity, minHeight: 76"))
        XCTAssertTrue(widget.contains("ForEach(0..<6"))
        XCTAssertTrue(widget.contains("ForEach(0..<3"))
    ...
    func testLiveASRReusesMainAgentSkillChain() throws {
        ...
        XCTAssertTrue(liveActivityWidget.contains("case \"understanding\", \"processing\", \"searching\": return \"思考\""))
        XCTAssertTrue(liveActivityWidget.contains("case \"summarizing\", \"speaking\": return \"回应\""))
