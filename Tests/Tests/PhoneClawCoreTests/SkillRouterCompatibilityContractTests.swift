...
final class SkillRouterCompatibilityContractTests: XCTestCase {
    ...
    func testLiveDynamicIslandSeparatesVoiceAndThinkingGlyphs() throws {
        ...
        XCTAssertTrue(widget.contains("case .voice: return .amber"))
        ...
        XCTAssertTrue(widget.contains(".frame(width: 66, height: 28)"))
    ...
    func testLiveDynamicIslandExpandedModeUsesLargeLivePanel() throws {
        ...
        XCTAssertTrue(widget.contains(".frame(width: 78, height: 42"))
        XCTAssertTrue(widget.contains(".frame(width: 72, height: 32"))
        XCTAssertTrue(widget.contains(".frame(maxWidth: .infinity, minHeight: 82"))
    ...
    func testLiveASRReusesMainAgentSkillChain() throws {
        ...
        XCTAssertTrue(liveActivityWidget.contains("case \"summarizing\": return \"整理中\""))
