...
final class SkillRouterCompatibilityContractTests: XCTestCase {
    ...
    func testLiveDynamicIslandSeparatesVoiceAndThinkingGlyphs() throws {
        ...
        XCTAssertTrue(widget.contains("private struct LiveRotatingSkillRing: View"))
        ...
        XCTAssertTrue(widget.contains(".trim(from: 0.10, to: 0.82)"))
        XCTAssertTrue(widget.contains(".rotationEffect(.degrees(t * 180.0))"))
